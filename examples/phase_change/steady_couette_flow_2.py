...
:math:`T _1 for x > 0, y=0`
:math:`T _0 for x > 0, y=H`
...
regions = {
    'Omega' : ('all', {}),
    'Gamma_Wall' : ('nodes in (x < -4.999999)', {}),
    'Gamma_Plate' : ('nodes in (x > 4.999999)', {}),
    'Gamma_Entry' : ('nodes in (y > 9.999999)', {}),
...
ebcs = {
    'T1' : ('Gamma_Wall', {'T.0' : 40}),
    'T2' : ('Gamma_Plate', {'T.0' : 20}),
    'T3' : ('Gamma_Entry', {'T.0' : 20}),
}
